...
<body>
 ...
 <div class="results results_section">
<div class="results">
    <?php
    ...
    <?php
         //pagination coding
                 $i=1;
    ?>
            <a href="" style="color:#7ED321 !important;">1</a>
    <?php
                 for($i=2;$i<=10;$i++)
                 {
    ?>
    ...
    <?php
                    for($i=1;$i<=10;$i++)
                    {
                        ...
                        {
                 ?>
                            <a href="<?php echo $this->config->base_url();?>index.php/Welcome2/results?page=<?php echo $i ;?>&value=<?php echo $value ;?>" style="color:#7ED321;">
                            <?php echo $i;?></a><?php
                        }
                        else
                        {
...
<div class="bottom-link">
    <ul>
        ...
        <li><a href="<?php echo $this->config->base_url();?>index.php/terms">Term and conditions -</a></li>
        <li><a href="<?php echo $this->config->base_url();?>index.php/privacy">Privacy Policy - </a></li>
        <li><a href="*">Feedbacks - </a></li>
        <li><a href="*">Donations</a></li>
    </ul>
